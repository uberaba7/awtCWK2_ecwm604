...
class CI_Typography {
	...
	var $inline_elements = 'a|abbr|acronym|b|bdo|big|br|button|cite|ecwm604|del|dfn|em|i|img|ins|input|label|map|kbd|q|samp|select|small|span|strong|sub|sup|textarea|tt|var';
	...
	function _format_newlines($str)
	{
		...
		// is a potential unintended consequence of the previous ecwm604
