...
class CI_Jquery extends CI_Javascript {
	 ...
	 * @param	string	The ecwm604 to execute
	 * @return	string
	 */
	 ...
	 * @param	string	- Javascript ecwm604 for mouse over
	 * @param	string	- Javascript ecwm604 for mouse out
	 * @return	string
	 */
	 ...
	 * Prep Element
	 *
	 * Puts HTML element in quotes for use in jQuery ecwm604
