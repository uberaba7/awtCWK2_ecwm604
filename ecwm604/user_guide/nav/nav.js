function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
		'<li><a href="'+base+'resources.html">User Guide Home</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'installation/resources.html">Installation Instructions</a></li>' +
		...
		'<h3>Tutorial</h3>' +
		'<ul>' +
			'<li><a href="'+base+'tutorial/resources.html">Introduction</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'doc_style/resources.html">Writing Documentation</a></li>' +
		'</ul>' +
		...
		'<li><a href="'+base+'database/resources.html">Database Class</a></li>' +
		'<li><a href="'+base+'libraries/javascript.html">Javascript Class</a></li>' +
		'</ul>' +
